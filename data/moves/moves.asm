...
Moves1:
	...
	move EFFECT_RAZOR_WIND,         80, FLYING,   100, 10,   0 ;RAZOR_WIND
	move EFFECT_ATTACK_UP_2,         0, STEEL,    100, 30,   0 ;SWORDS_DANCE
	...
	move EFFECT_JUMP_KICK,         100, FIGHTING,  95, 25,   0 ;JUMP_KICK
	...
	move EFFECT_NORMAL_HIT,         40, NORMAL,    95, 35,   0 ;TACKLE
	...
	move EFFECT_RAMPAGE,           120, NORMAL,   100, 20,   0 ;THRASH
	...
	move EFFECT_MIST,                0, FLYING,   100, 30,   0 ;MIST
	...
	move EFFECT_NORMAL_HIT,         80, FIGHTING,  90, 25,   0 ;SUBMISSION
	...
	move EFFECT_RAMPAGE,           120, GRASS,    100, 20,   0 ;PETAL_DANCE
	...
	move EFFECT_THUNDER,           120, ELECTRIC,  80, 10,  30 ;THUNDER
	...
	move EFFECT_FLY,                90, GROUND,   100, 10,   0 ;DIG
	...
	move EFFECT_SLEEP,               0, PSYCHIC,   70, 20,   0 ;HYPNOSIS
	...
	move EFFECT_DEFENSE_UP,          0, STEEL,    100, 40,   0 ;WITHDRAW
	...
	move EFFECT_MIRROR_MOVE,         0, NORMAL,   100, 20,   0 ;MIRROR_MOVE
	move EFFECT_SELFDESTRUCT,      200, FIRE,     100,  5,   0 ;SELFDESTRUCT
	...
	move EFFECT_BURN_HIT,          120, FIRE,      80,  5,  10 ;FIRE_BLAST
	...
	move EFFECT_SPEED_DOWN_HIT,     40, NORMAL,   100, 35, 100 ;CONSTRICT
	...
	move EFFECT_LEECH_HIT,          80, BUG,      100, 15,   0 ;LEECH_LIFE
	move EFFECT_SLEEP,               0, FAIRY,     75, 10,   0 ;LOVELY_KISS
	...
	move EFFECT_TRIPLE_KICK,        30, FIGHTING,  90, 10,   0 ;TRIPLE_KICK
	...
	move EFFECT_PARALYZE_HIT,      100, ELECTRIC,  70,  5, 100 ;ZAP_CANNON
	...
	move EFFECT_ROLLOUT,            30, ROCK,      95, 20,   0 ;ROLLOUT
	...
	move EFFECT_ATTRACT,             0, FAIRY,    100, 15,   0 ;ATTRACT
	...
	move EFFECT_PAIN_SPLIT,          0, GHOST,    100, 20,   0 ;PAIN_SPLIT
	...
	move EFFECT_PURSUIT,            60, DARK,     100, 20,   0 ;PURSUIT
	move EFFECT_RAPID_SPIN,         50, NORMAL,   100, 40,   0 ;RAPID_SPIN
	...
	move EFFECT_MORNING_SUN,         0, FIRE,     100,  5,   0 ;MORNING_SUN
	...
	move EFFECT_TWISTER,            65, DRAGON,   100, 20,  20 ;TWISTER
	...
	move EFFECT_DEFENSE_DOWN_HIT,   50, FIGHTING, 100, 15,  50 ;ROCK_SMASH
	move EFFECT_TRAP_TARGET,        40, WATER,     70, 15,   0 ;WHIRLPOOL
	move EFFECT_BEAT_UP,            20, DARK,     100, 10,   0 ;BEAT_UP
	move EFFECT_SP_ATK_DOWN_HIT,    50, BUG,      100, 20, 100 ;STRUGGLE_BUG
	move EFFECT_ATTACK_DOWN_2,       0, FLYING,   100, 15,   0 ;FEATHERDANCE
	...
	move EFFECT_MULTI_HIT,          25, FIGHTING, 100, 20,   0 ;ARM_THRUST
	move EFFECT_PARALYZE_HIT,       20, ELECTRIC, 100, 20, 100 ;NUZZLE
	move EFFECT_SP_ATK_UP_2,         0, DARK,     100, 20,   0 ;NASTY_PLOT
	move EFFECT_STOMP,             100, DRAGON,    75, 10,  20 ;DRAGON_RUSH
	move EFFECT_FLINCH_HIT,         80, DARK,     100, 15,  20 ;DARK_PULSE
	move EFFECT_SP_DEF_DOWN_HIT,    90, GRASS,    100, 10,  10 ;ENERGY_BALL
	move EFFECT_POISON_HIT,         50, POISON,   100, 15,  50 ;POISON_FANG
	move EFFECT_ALL_UP_HIT,         60, BUG,      100,  5,  10 ;SILVER_WIND
	move EFFECT_SPEED_DOWN_HIT,     60, ROCK,      95, 15, 100 ;ROCK_TOMB
	move EFFECT_SP_DEF_DOWN_HIT,   120, FIGHTING,  75,  5,  10 ;FOCUSBLAST
	move EFFECT_FLINCH_HIT,			75, FLYING,	   95, 15,  30 ;AIR_SLASH
	move EFFECT_LEECH_HIT,			75, GRASS,	  100, 10, 100 ;HORN_LEECH
	move EFFECT_DOUBLE_HIT,			40, DRAGON,	   90, 15,   0 ;DUAL_CHOP
	move EFFECT_SP_DEF_DOWN_HIT,	80, STEEL,	  100, 10,  10 ;FLASHCANNON
	move EFFECT_FLINCH_HIT,			30, GHOST,	  100, 15,  30 ;ASTONISH
	move EFFECT_CONFUSE_HIT,	   110, FLYING,	   70, 10,  30 ;HURRICANE
	move EFFECT_DEFENSE_UP_2,		 0, GRASS,	  100, 10,   0 ;COTTON_GUARD
	move EFFECT_ROLLOUT,		    30, ICE,       95, 20,	 0 ;ICE_BALL
